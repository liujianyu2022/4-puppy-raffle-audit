...
contract PuppyRaffle is ERC721, Ownable {
    ...
    /*
        audit: the max value for type uint64 is about 18 ether, which is a achievable value.
               overflow occurs as soon as as the maximum is exceeded.
    */
    ...
    function selectWinner() external {
        ...
        /*
            audit: weak randomness, hashing msg.senderm block.timestamp and block.difficultly together creates a predicatable value
                   which is not a good random number, malicious users can manipulate them to obtain a value in their favor.          
        */
        uint256 winnerIndex =
            uint256(
                    keccak256(
